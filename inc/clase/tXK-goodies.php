...
class Zend_Search_Lucene_Analysis_Analyzer_Common_Utf8NumComplex extends Zend_Search_Lucene_Analysis_Analyzer_Common
{
    /**
...
class Zend_Search_Lucene_Analysis_Analyzer_Common_Utf8NumComplex_CaseInsensitive extends Zend_Search_Lucene_Analysis_Analyzer_Common_Utf8NumComplex
{
    public function __construct()
    {
        parent::__construct();
...
class tXK_Highlight extends Zend_Search_Lucene_Search_Highlighter_Default { protected $_highlightColors = array('#33F633', '#99D25D', '#FCD804','#FCA09C', '#4BCFFF', '#FF7707','#3169B6', '#A9E8FA', '#D1FC78','#C9A16D', '#D8A69B', '#FFFB94','#B9FD5E', '#D6FF1D', '#FAE3B7'); } 